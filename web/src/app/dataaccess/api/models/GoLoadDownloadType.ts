...
export function instanceOfGoLoadDownloadType(value: any): boolean {
    for (const key in GoLoadDownloadType) {
        if (Object.prototype.hasOwnProperty.call(GoLoadDownloadType, key)) {
            if (GoLoadDownloadType[key as keyof typeof GoLoadDownloadType] === value) {
                return true;
            }
        }
    }
...
export function GoLoadDownloadTypeToJSONTyped(value: any, ignoreDiscriminator: boolean): GoLoadDownloadType {
    return value as GoLoadDownloadType;
}
